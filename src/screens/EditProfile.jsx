...
const EditProfile = () => {
  ...
  const {updatedEmail, updatedName, updatedDescription} = route.params || {};
  ...
  const updateProfile = async () => {
    try {
      ...
      // Now, you can navigate to the 'Profile' screen
  ...
  const [username, setUsername] = useState(updatedName || 'Rose Peter');
