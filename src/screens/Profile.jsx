...
const Profile = () => {
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: 'white', color: 'black'}}>
      <StatusBar backgroundColor="grey" />
      <View style={{width: '100%'}}>
        <Image
          source={{
            uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvGLIB5nbm0lkh1qxoj6lhjM_y0Jx_itVW7Q&usqp=CAU',
          }}
