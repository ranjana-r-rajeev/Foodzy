...
//     // Navigate to LikeScreen with the selected post details
//     // navigation.navigate('LikeScreen', { post: item });
//     {posts.item}
//   };
...
//             marginVertical: 10,
//           }}>
//           <Icon name="heart" size={20} color="red" style={styles.icon} onPress={() => handleLikePress(item)}/>
//           <Icon
//             name="comment"
//             size={20}
//             color="black"
      ...
      <View style={styles.postContainer}>
        ...
        >
          <Icon
            name="heart"
            size={20}
            color={likedItems.some((likedItem) => likedItem.id === item.id) ? 'red' : 'black'}
            style={styles.icon}
          ...
          />
          <TouchableOpacity
            onPress={() => handlePhonePress(item.phoneno)}
          >
            <Icon
              name="phone"
              size={20}
  ...
  return (
    ...
    const styles = StyleSheet.create({
        ...
        postDescription: {
          fontSize: 16,
          marginBottom: 8,
          color: 'grey', // Add a color to indicate it's clickable
        },
      });
